...
class GlobalAuditLogScreen extends ConsumerWidget {
  const GlobalAuditLogScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final historyRepo = ref.read(transactionHistoryRepositoryProvider);
    final history = historyRepo.getAllHistory();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('History & Audit Log', style: TextStyle(color: AppColors.textPrimary)),
      ),
      body: history.isEmpty
          ? const Center(
              child: Text('No audit history found.',
